...
// KAT: creating a json object to be passed to the addItem function in the Express app
    const jsonObject = {
      id: this.state.id,
...
// KAT: making a POST request the addItem function located in our Express Application and returning a response message
    Axios({
      method: "POST",
